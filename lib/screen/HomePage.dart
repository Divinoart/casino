...
import 'package:casino/Widgets/CardMovimentacoesItem.dart';
import 'package:casino/Widgets/CustomDialog.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  var formattedCalendar = new DateFormat('MM-yyyy');
  String dateFormat;
  ...
  _salvar() {
    dateFormat = formattedDate.format(currentDate);
  ...
  void initState() {
    ...
    //_salvar();
    dateFormat = formattedCalendar.format(currentDate);
    print(dateFormat);
    _allMovMes(dateFormat);
          ...
          children: <Widget>[
                ...
                Positioned(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.only(bottomRight:  Radius.elliptical(30, 15), bottomLeft:  Radius.elliptical(30, 15)),//Colors.indigo[400],
                      )),
                ),
                Positioned(
                  top: width * 0.18, //70
                  ...
                  child: Text(
                    "KashFlow",
                    style: TextStyle(
                        color: Colors.white, fontSize: width * 0.074, fontWeight: FontWeight.w600 //30
                        ),
                  ),
                ),
                Positioned(
                          ...
                          children: <Widget>[
                            Padding(
                              ...
                              child: Container(
                                ...
                                style: TextStyle(
                                    color: Colors
                                        .deepPurple[900], //Colors.indigo[400],
                                    fontWeight: FontWeight.bold,
                                    fontSize: _saldoTamanho(currentBalance),
            ...
            TableCalendar(
              ...
              onVisibleDaysChanged: (dateFirst, dateLast, CalendarFormat cf) {
                ...
                dateFormat = formattedCalendar.format(dateFirst);
                _allMovMes(dateFormat);

                print("DATA FORMATADA CALENDAR $dateFormat");
